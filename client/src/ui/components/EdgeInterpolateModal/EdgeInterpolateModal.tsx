...
export function EdgeInterpolateModal({
  isOpen,
  onClose,
  onConfirm,
}: EdgeInterpolateModalProps) {
  ...
  return createPortal(
    <div
      className="edge-interpolate-modal__backdrop"
      onClick={handleBackdropClick}
    >
      <div
        className="edge-interpolate-modal"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="edge-interpolate-modal__header">
          <h3>
            <Icon icon={Wrench} size={16} /> Auto Compute Normals (Edge
            Interpolate)
          </h3>
        ...
        <div className="edge-interpolate-modal__content">
          <div className="edge-interpolate-modal__control">
            <label className="edge-interpolate-modal__label">
              <span className="edge-interpolate-modal__label-text">
                Starting Angle
              </span>
              <span className="edge-interpolate-modal__label-value">
                {startAngle}°
              </span>
            </label>
            <div className="edge-interpolate-modal__slider-group">
              ...
              <div className="edge-interpolate-modal__hints">
                <span className="edge-interpolate-modal__hint">
                  -90° (inward)
                </span>
            ...
            <div className="edge-interpolate-modal__description">
              Controls the initial direction of edge normals. Positive angles
              point away from the pixel, negative angles point toward the pixel.
            </div>
          </div>
          ...
          <div className="edge-interpolate-modal__control">
            ...
            <div className="edge-interpolate-modal__description">
              Controls the smoothness of the Gaussian RBF interpolation. Higher
              values create smoother transitions.
            </div>
          </div>
          ...
          <div className="edge-interpolate-modal__control">
            ...
            <div className="edge-interpolate-modal__description">
              Controls the influence radius of the Gaussian RBF. Larger values
              allow edge normals to influence pixels further away.
            </div>
          </div>
          ...
          <div className="edge-interpolate-modal__control">
            ...
            <div className="edge-interpolate-modal__description">
              When enabled, the computed normals will be applied to all frames
              that contain the current layer.
            </div>
          </div>
        </div>
        ...
        <div className="edge-interpolate-modal__actions">
          <button
            className="edge-interpolate-modal__btn edge-interpolate-modal__btn--neutral"
            onClick={onClose}
          >
            Cancel
          </button>
          <button
            className="edge-interpolate-modal__btn edge-interpolate-modal__btn--primary"
