  ...
  function ObjectThumbnail({
    ...
    return (
      <canvas
        ...
        width={thumbSize}
        height={thumbSize}
        className="object-select-modal__thumb-canvas"
      />
    );
  },
  (prevProps, nextProps) => {
...
export function ObjectSelectModal({
  ...
  return createPortal(
    <div
      className="object-select-modal__backdrop"
      onClick={handleBackdropClick}
    >
      <div className="object-select-modal">
        <div className="object-select-modal__header">
          <h3>
            <Icon icon={Package} size={16} /> Select Reference Object
          </h3>
          <span className="object-select-modal__subtitle">
            Choose which object's frames to preview
          </span>
        ...
        <div className="object-select-modal__content">
          ...
          >
            <div className="object-select-modal__current-icon">
              <Icon icon={Target} size={18} />
            </div>
            <div className="object-select-modal__info">
              <span className="object-select-modal__name">
                Follow Current Object
              </span>
            ...
            {selectedObjectId === null && (
              <div className="object-select-modal__badge--selected">
              ...
              return (
                ...
                >
                  ...
                  <div className="object-select-modal__info">
                    ...
                    <span className="object-select-modal__details">
                      {obj.gridSize.width}×{obj.gridSize.height} •{" "}
                      {obj.frames.length} frame
                      {obj.frames.length !== 1 ? "s" : ""}
                    </span>
                  </div>

                  {isCurrent && (
                    <div className="object-select-modal__badge--current">
                      Current
                    </div>
                  )}
